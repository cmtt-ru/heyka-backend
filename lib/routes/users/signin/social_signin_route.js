  ...
  return [Helpers.withDefaults({
    ...
    handler: async function (request, h) {
      ...
      try {
        ...
        const avatarFileId = await fileService.uploadS3FromUrl(externalAvatarUrl, avatarFileIdForS3);

        const avatarSet = await fileService.getImgproxyImageSet('avatar', avatarFileId);
