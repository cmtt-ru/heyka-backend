...
module.exports = Helpers.withDefaults({
  ...
  options: {
    ...
    response: {
      ...
      status: {
        200: Joi.object({
          image_32x32: Joi.string().uri().required(),
          image_64x64: Joi.string().uri().required(),
        }),
  ...
  handler: async (request, h) => {
    ...
    try {
      ...
      return {
        image_32x32: fileService.getImgproxyUrl(filename, 32),
        image_64x64: fileService.getImgproxyUrl(filename, 64)
      };
    } catch(e) {
