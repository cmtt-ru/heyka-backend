...
module.exports = class WorkspaceService extends Schmervice.Service {
  ...
  /**
   * Returns average and median count of channels in workspace
   */
  async getWorkspaceStatistics () {
    ...
    return {
      average: helpers.average(countsChannelsInWorkspace),
      median: helpers.median(countsChannelsInWorkspace)
    };
