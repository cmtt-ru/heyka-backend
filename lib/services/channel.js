...
module.exports = class ChannelService extends Schmervice.Service {
   ...
   * @param {uuid} channelId Channel Id
   * @param {Array<uuid>} memberList List of user ids that should be included to the channel
   * @returns {Array<uuid>} Filtered Members List
   */
  async checkLimitOfChannelMembers(channelId, memberList){
    const {
