...
module.exports = class ChannelDatabaseService extends Schmervice.Service {
  ...
  async getChannelById(id) {
    const db = this.plugins['hapi-pg-plugin'].db;
   ...
   */
  async switchUserToChannel(channelId, userId) {
    ...
    await client.set(`channel-for-user-${userId}`, channelId);
    await client.sadd(`users-in-channel-${channelId}`, userId);
    return channelId
  }
