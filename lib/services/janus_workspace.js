...
const DEFAULT_PUBLIC_JANUS_URL = process.env.DEFAULT_PUBLIC_JANUS_URL || 'http://172.17.0.4';
...
module.exports = class JanusWorkspaceService extends Schmervice.Service {
  ...
  async createServer () {
    ...
    const janusInfo = {
      ...
      public_url: DEFAULT_PUBLIC_JANUS_URL,
      api_port: 8088,
      api_path: 'janus',
      admin_path: 'admin',
      admin_port: 7088,
  ...
  async createAudioVideoRooms (id, janusServerInfo, channelSecret) {
    const url = janusServerInfo.public_url
