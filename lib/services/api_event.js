...
module.exports = class ApiEventService extends Schmervice.Service {
  ...
  */
   ...
   * @param {string} workspaceId Workspace id
  */
  channelCreatedForUser(userId, channelId, workspaceId) {
    this.server.apiEvents.emit('api-event', {
      data: {
        channelId,
        workspaceId,
  ...
  /**
   * Generated api-event about channel deleted for user
   * @param {string} userId
   * @param {string} workspaceId Workspace id
   * @param {string} channelId Channel id
   */
  channelDeletedForUser(userId, workspaceId, channelId) {
    this.server.apiEvents.emit('api-event', {
      data: {
        channelId,
        workspaceId,
   ...
   * @param {string} oStatus New online status
   */
  onlineStatusUpdated(userId, workspaceId, oStatus) {
    console.log('API event --> onlineStatusUpdated', userId, workspaceId, oStatus)
    this.server.apiEvents.emit('api-event', {
      data: {
        userId,
        onlineStatus: oStatus || 'offline',
      },
